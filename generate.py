...
Flags:
    -n, --count N        Number of textures to generate (default: 10)
    -s, --seed N         Random seed for reproducibility
    --noise TYPE         Noise type: white, pink, brown (default: random)
    --freq HZ            Base frequency in Hz (default: random 50-500)
    --duration SEC       Duration in seconds (default: random 2-8)
    --amplitude VAL      Amplitude 0.0-1.0 (default: random 0.3-1.0)
